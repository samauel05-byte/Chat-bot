...
export function NalaWorkspace({ isOwner = false, quotaContext }: { isOwner?: boolean; quotaContext: QuotaContext }) {
  ...
  return (
    <>
      ...
      <button onClick={() => setAccountOpen(true)} className="fixed left-4 top-4 z-40 rounded-lg border border-white/15 bg-slate-900 px-3 py-2 text-sm font-semibold text-white shadow-lg">🔐 Cambiar clave</button>
